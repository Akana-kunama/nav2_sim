...
#include "custom_command/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_command
cdr_serialize(
  const custom_command::msg::Command & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_command::msg::Command & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_command::msg::Command;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_command::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_command::msg::Command *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_custom_command
const rosidl_message_type_support_t *
get_message_type_support_handle<custom_command::msg::Command>()
{
  return &custom_command::msg::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_command, msg, Command)() {
  return &custom_command::msg::typesupport_fastrtps_cpp::_Command__handle;
}
