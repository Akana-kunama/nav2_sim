...
bool custom_command__msg__command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_command.msg._command.Command", full_classname_dest, 35) == 0);
  }
  custom_command__msg__Command * ros_message = _ros_message;
  {  // name
...
PyObject * custom_command__msg__command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_command.msg._command");
